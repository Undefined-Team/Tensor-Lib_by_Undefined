...
ud_tensor   *ud_tens_dot(ud_tensor *a, ud_tensor *b, ud_arr *axis)
{
    ...
    size_t  axis_len = ((ud_arr **)axis->val)[0]->len;
    ud_arr *mem_shapes = ud_arr_tinit(ud_matha_type_size_t(), (tens_len - axis_len) * 2);
    ...
    ud_arr *new_dim_a = ud_arr_tinit(ud_matha_type_size_t(), tens_len);
    ud_arr *new_dim_b = ud_arr_tinit(ud_matha_type_size_t(), tens_len);
